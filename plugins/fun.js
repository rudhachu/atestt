...
const bq = [
  "The most amount yolks found in a single chicken egg were 9 yolks.",
  "Although an owl can turn its head 360 degree it cannot move its eyes.",
  "The eggs of humming bird are of the size of a pea.",
  ...
  "World’s only wingless bird is the Kiwi of New Zealand.",
  "The egg of an ostrich needs to be boiled for 2-hours in order to be a hard-boiled egg.",
  "The world’s only poisonous bird is Pitohui of Papua, the poison is found on its skin and feathers.",
